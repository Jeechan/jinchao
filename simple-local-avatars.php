...
class Simple_Local_Avatars {
	...
	public function __construct() {
		...
		$this->avatar_ratings = array(
			'G' => __('G &#8212; 适合任何年龄的访客查看'),
			'PG' => __('PG &#8212; 可能有争议的头像，只适合13岁以上读者查看'),
			'R' => __('R &#8212; 成人级，只适合17岁以上成人查看'),
			'X' => __('X &#8212; 最高等级，不适合大多数人查看')
		);
...
wp_enqueue_script( 'simple-local-avatars', get_template_directory_uri( '', __FILE__ ) . '/js/simple-local-avatars' . $script_name_append . '.js', array('jquery'), false, true );
		wp_localize_script( 'simple-local-avatars', 'i10n_SimpleLocalAvatars', array(
			...
			'insertIntoPost'	=> __('选择','simple-local-avatars'),
	...
	?>
	<h3><?php _e( '本地头像','simple-local-avatars' ); ?></h3>
	...
	<table class="form-table">
		<tr>
			...
			?>
					...
					<p>
						<?php if ( current_user_can( 'upload_files' ) && did_action( 'wp_enqueue_media' ) ) : ?><a href="#" class="button hide-if-no-js" id="simple-local-avatar-media"><?php _e( '从媒体库选择', 'simple-local-avatars' ); ?></a> &nbsp;<?php endif; ?>
						<a href="<?php echo $remove_url; ?>" class="button item-delete submitdelete deletion" id="simple-local-avatar-remove"<?php if ( empty( $profileuser->simple_local_avatar ) ) echo ' style="display:none;"'; ?>><?php _e('删除本地头像','simple-local-avatars'); ?></a>
					</p>
			<?php
				} else {
